...
def generate_icon_widget():
    icon_name = random.choice(["Icons.home", "Icons.search", "Icons.settings", "Icons.add", "Icons.favorite"])
...
for i in range(1, num_files + 1):
    dart_code = generate_icon_widget()
    dart_file_path = os.path.join(dart_files_output_dir, f"icon_{i}.dart")
    screenshot_path = os.path.join(screenshot_output_dir, f"icon_{i}.png")
