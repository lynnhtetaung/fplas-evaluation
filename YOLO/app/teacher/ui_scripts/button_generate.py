...
def generate_button_widget():
    button_text = random.choice(["Submit", "Click Me", "Start", "Continue", "Cancel"])
    button_color = random.choice(["Colors.blue", "Colors.green", "Colors.red", "Colors.orange", "Colors.purple"])
        ...
        body: Center(
          child: ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              primary: {button_color}, // Set your button color here
...
for i in range(1, num_files + 1):
    dart_code = generate_button_widget()
    dart_file_path = os.path.join(dart_files_output_dir, f"button_ui_{i}.dart")
    screenshot_path = os.path.join(screenshot_output_dir, f"button_ui_{i}.png")
