...
for i in range(1, num_files + 1):
    dart_code = generate_checkbox_widget()
    dart_file_path = os.path.join(dart_files_output_dir, f"checkbox_{i}.dart")
    screenshot_path = os.path.join(screenshot_output_dir, f"checkbox_{i}.png")
