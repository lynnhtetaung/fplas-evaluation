...
import os
from components.ocr_detector import detect_components  # Import the OCR detection function
...
def upload():
    ...
    # Detect components using OCR
    try:
        print("Come to OCR")
        # The detect_components function should now perform OCR detection
    ...
    # Render result template with detection percentage and images
    result_template = render_template(
        'ocr-result.html',  # Updated to 'ocr-result.html'
